...
using MyPassword.Sessions;
using MyPassword.Web.Controllers.Results;
using MyPassword.Web.Models;
using MyPassword.Web.Models.Account;
...
{
    public class AccountController : MyPasswordControllerBase
    {
